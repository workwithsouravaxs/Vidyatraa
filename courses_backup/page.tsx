...
export default function Home() {
  ...
  const handleApplyCoupon = () => {
    ...
    if (activeCoupons.includes(codeUpper)) {
      ...
      setDiscountMsg("🎉 Coupon applied! Gained flat ₹20 discount on Vidyatraa Pro!");
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fefefe]">
      ...
      <section className="py-20 px-4 md:px-8 border-b-4 border-navy bg-indigo-50 relative overflow-hidden text-left">
        {/* Cartoon decorations */}
        <div className="absolute top-10 left-10 text-4xl opacity-15">📊</div>
        <div className="absolute bottom-10 right-10 text-4xl opacity-15">🎯</div>
      ...
      <section className="py-20 px-4 md:px-8 border-b-4 border-navy bg-emerald-50 relative overflow-hidden text-left">
        {/* Cartoon decorations */}
        <div className="absolute top-10 right-10 text-4xl opacity-15">📖</div>
        <div className="absolute bottom-10 left-10 text-4xl opacity-15">💡</div>
        ...
        <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full items-stretch">
            ...
            <div className="cartoon-card p-5 bg-white border-3 border-primary flex flex-col justify-between relative shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] hover:translate-y-[-4px] hover:shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] transition-all">
              ...
              <div className="text-left">
                <h3 className="text-lg font-bold font-fredoka text-navy mb-1">Vidyatraa Pro</h3>
                <div className="mb-3">
