...
const HERO_SLIDES = [
  {
    src: '/hero_vidyatraa.png',
    alt: 'Vidyatraa Hero Main Showcase'
  },
  {
    src: '/hero_1_vidyatraa.png',
    alt: 'Vidyatraa Ecosystem Showcase'
  }
];
...
export default function RedesignedHome() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fafafb] text-[#0f172a] overflow-x-hidden font-sans">
      ...
      {/* 🌟 Auto-Sliding Hero Carousel Section */}
      <section className="relative w-full max-w-7xl mx-auto px-4 md:px-8 pt-6 md:pt-8">
        <div 
          className="relative w-full rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-2xl border border-slate-150 bg-white group"
        ...
        >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-slate-900/10 hover:bg-slate-900/20 backdrop-blur-md text-slate-800 p-2 sm:p-3 rounded-full transition-all border border-slate-900/10 shadow-sm opacity-80 md:opacity-0 group-hover:opacity-100 z-30 cursor-pointer focus:outline-none"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-slate-900/10 hover:bg-slate-900/20 backdrop-blur-md text-slate-800 p-2 sm:p-3 rounded-full transition-all border border-slate-900/10 shadow-sm opacity-80 md:opacity-0 group-hover:opacity-100 z-30 cursor-pointer focus:outline-none"
          ...
          <div className="absolute bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2.5 z-30">
            {HERO_SLIDES.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full transition-all duration-300 cursor-pointer focus:outline-none ${
                  currentSlide === index 
